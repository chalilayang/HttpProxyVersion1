...
typedef std::map<boost::shared_ptr<LocalHttpConnection>, std::pair<sh_int_64, sh_int_64> >	SHConnectionMap;
...
public:
    ...
    void stop(void);
	void on_connection_close(boost::shared_ptr<LocalHttpConnection> con, sh_int_64 call_id);
	void on_connection_close(sh_int_64 uid, boost::shared_ptr<LocalHttpConnection> sp_connection);
	void on_connection_update(sh_int_64 uid, sh_int_64 call_id, boost::shared_ptr<LocalHttpConnection> sp_connection);
...
public: /*实现IP2PDownloadSink, p2p回调接口*/
	...
	//接收p2p数据
	virtual void on_recv_p2p_video_data(sh_int_64 unique_id, sh_uint_32 index, sh_int_8_p data, sh_uint_32 len, bool isheader, sh_int_32 real_mp4_size, sh_int_32 cur_download_pos, sh_int_64 call_id);
...
public: 
	...
	sh_int_64 get_call_id_num(void);
...
private:
	...
	boost::shared_ptr<LocalHttpConnection> get_http_connection(sh_int_64 unique_id, sh_int_64 call_id);
	...
	void recv_p2p_video_data(sh_int_64 unique_id, sh_uint_32 index, std::string data, sh_uint_32 len, bool isheader, sh_int_32 real_mp4_size, sh_int_32 cur_download_pos, sh_int_64 call_id);
