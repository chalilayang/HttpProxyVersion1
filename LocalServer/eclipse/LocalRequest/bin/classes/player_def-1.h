...
struct SHCDNInfo
{
  ...
  SHCDNInfo() {};
  SHCDNInfo(const tstring& strIp, const tstring& strKey,const tstring& strUrl, int32_t idc = 0, bool isp2p = true)
  {
    ip	= strIp;
    key	= strKey;
    url = strUrl;
