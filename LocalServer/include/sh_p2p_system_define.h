...
typedef void(SHP2P_CALLBACK *recv_video_data_notify)(sh_int_64 unique_id,sh_uint_32 index,/*SHRequestType request_type,*/sh_int_8_p data,sh_uint_32 len, bool isheader, sh_int_32 real_mp4_size, sh_int_64 seq);
...
typedef void(SHP2P_CALLBACK *video_error_notify)(sh_int_64 unique_id,sh_uint_32 index,/*SHRequestType request_type,*/
												enum SHP2pErrorType error_type,sh_uint_32 error_code, sh_int_64 seq);
